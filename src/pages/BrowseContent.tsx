  ...
  return (
    <div className="relative z-0 p-6">
      ...
      <div className="relative z-10 mb-6">
        <div className="relative max-w-2xl">
          ...
          <Input
            ...
            className="cms-input pl-10 bg-cms-surface border-cms-border"
          />
        </div>
      </div>

      {/* Filters */}
      <div className="relative z-20 grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        <div>
          <label className="block text-sm font-medium text-cms-text-secondary mb-2">Filter by Genre</label>
          <Select>
            <SelectTrigger className="cms-input bg-cms-surface border-cms-border">
              <SelectValue placeholder="All Genres" />
            </SelectTrigger>
            <SelectContent className="bg-cms-surface border-cms-border z-50">
      ...
      <div className="relative z-10">
        <Card className="cms-card min-h-[400px] flex items-center justify-center bg-cms-surface border-cms-border">
          {hasError ? (
            <div className="text-center">
              ...
              <Button
                ...
                className="cms-button-primary bg-yellow-400 hover:bg-yellow-500 text-black"
              >
            ...
            <div className="text-center">
              ...
              <Button className="cms-button-primary bg-yellow-400 hover:bg-yellow-500 text-black">
