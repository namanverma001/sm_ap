  ...
  return (
    <div className="p-6">
      ...
      <div className="relative z-10 flex items-center justify-between mb-8">
        ...
        <Button
          type="button"
          className="relative z-10 cms-button"
          onClick={(e) => {
            e.preventDefault();
          ...
          <Card key={collection.id} className="cms-card group hover:scale-105 transition-transform duration-300">
            ...
            <div className="space-y-3">
              ...
              <Button
                type="button"
                variant="outline"
                className="relative z-10 w-full cms-button-outline mt-4 group-hover:bg-cms-primary group-hover:text-black group-hover:border-cms-primary transition-colors"
                onClick={(e) => {
                  e.preventDefault();
