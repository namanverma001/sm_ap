...
import { Star, Save, Image, Video } from "lucide-react";
    ...
    return (
        <div className="p-6 flex flex-col items-center min-h-[calc(100vh-4rem)]">
            ...
            <div className="mb-8 text-center">
                <h1 className="text-3xl font-bold text-cms-primary mb-2">Update Movie</h1>
                <p className="text-cms-text-secondary">Update movie details in your content library</p>
            </div>
                ...
                <Card className="cms-card">
                    <form className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div className="cms-upload-area">
                                    ...
                                    <p className="text-sm text-cms-text-secondary mb-1">Update poster image</p>
                            ...
                            <div>
                                ...
                                <div className="cms-upload-area">
                                    <Image className="w-8 h-8 text-cms-primary mb-2" />
                                    <p className="text-sm text-cms-text-secondary mb-1">Update backdrop image</p>
                                    <p className="text-xs text-cms-text-muted">PNG, JPG, WEBP up to 10MB</p>
                                    <p className="text-xs text-cms-primary mt-2 cursor-pointer hover:underline">
                                        Click to browse or drag & drop
                                    </p>
                            ...
                            <div>
                                ...
                                <div className="cms-upload-area">
                                    ...
                                    <p className="text-sm text-cms-text-secondary mb-1">Update video file</p>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label className="block text-cms-primary font-medium mb-2">Content Type</label>
                                <Select>
                                    <SelectTrigger className="cms-select">
